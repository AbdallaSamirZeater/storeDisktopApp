 ...
 * @author ab o da
 */
public class multipleSale extends javax.swing.JFrame {
    ...
    private void translate() {
        if (Home.lang_lbl.getText().equals("عربي")) {
            convertLang(new JLabel[]{
                branch_lbl, user_lbl, date_lbl, cName_lbl, id_lbl, quant_lbl, total_lbl, paid_lbl, rest_lbl, check_id, dept_lbl00 , clear_lbl , add_lbl
            }, 0);
    ...
    private void initComponents() {
        ...
        quantity.setFont(new java.awt.Font("Segoe UI Semibold", 0, 20)); // NOI18N
        quantity.setText("1");
        itemPanel3.add(quantity, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 110, 310, 50));
        ...
        add_lbl.setText("Add");
        salesPanel1.add(add_lbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 500, 60, 30));
        ...
        salesPanel1.add(clear_lbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 500, 70, 30));
        ...
        itemPanel4.add(deptBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 155, -1, -1));
    ...
    private void add_icon3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_add_icon3MouseClicked
        ...
        long stock_id = 0;
        int stockQuant = 0, flag = 0, clientId = 0, check_id = 0, counter = 0;
        ...
        try {
            ...
            for (int i = 0; i < salesTable.getRowCount(); i++) {
                ...
                quant = Float.parseFloat(String.valueOf(multiSalesTable.getModel().getValueAt(i, 3)));
                total = price * quant;
                allTotal += total;
                ...
                if (stockQuant >= quant) {
                    ...
                    String ss = "UPDATE `stock` SET `Quantity`= '" + (stockQuant - quant) + "' WHERE stock.`ID` = " + stock_id + ";";
                    d.st = d.con.createStatement();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(multipleSale.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new multipleSale().setVisible(true);
            }
        });
    }
