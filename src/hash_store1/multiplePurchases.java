 ...
 * @author ab o da
 */
public class multiplePurchases extends javax.swing.JFrame {

    /**
     * Creates new form multiplePurchases
     */
    DefaultTableModel purchasesTable;

    public multiplePurchases() {
        initComponents();
        Home.styleTable(new JTable[]{multiPurchasesTable});
        translate();
        purchasesTable = createTableCols(multiPurchasesTable, new String[]{"ID", "Item", "Price", "Quantity"});
        branch();
    }
    ...
    private void translate() {
        if (Home.lang_lbl.getText().equals("عربي")) {
            convertLang(new JLabel[]{
                branch_lbl, user_lbl, date_lbl, cName_lbl, id_lbl, quant_lbl, total_lbl, paid_lbl, rest_lbl, check_id , dept_lbl00
            }, 0);
    ...
    void branch() {
        ...
        multiPurchasesComboBox.removeAllItems();
        try {
            d.rs = d.st.executeQuery(sql2);
            while (d.rs.next()) {
                multiPurchasesComboBox.addItem(d.rs.getString("name"));
            }
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        quant_lbl = new javax.swing.JLabel();
        ...
        multiPurchasesComboBox = new javax.swing.JComboBox<>();
        ...
        setPreferredSize(new java.awt.Dimension(1194, 740));
        setSize(new java.awt.Dimension(1194, 800));
        ...
        Quant.setFont(new java.awt.Font("Segoe UI Semibold", 0, 20)); // NOI18N
        Quant.setText("1");
        itemPanel3.add(Quant, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 110, 310, 50));

        quant_lbl.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        quant_lbl.setText("Quantity :");
        itemPanel3.add(quant_lbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 110, 100, 50));

        stockId.setFont(new java.awt.Font("Segoe UI Semibold", 0, 20)); // NOI18N
        stockId.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                stockIdKeyPressed(evt);
            }
        });
        itemPanel3.add(stockId, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 40, 310, 50));

        id_lbl.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        id_lbl.setText("ID :");
        itemPanel3.add(id_lbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 40, 120, 50));

        salesPanel1.add(itemPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 530, 200));
        ...
        salesPanel1.add(add_icon3, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 440, 50, 60));
        ...
        salesPanel1.add(add_lbl3, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 500, 60, 30));
        ...
        salesPanel1.add(clear_icon3, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 440, 50, 60));
        ...
        salesPanel1.add(search_lbl3, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 500, 70, 30));
        ...
        itemPanel4.add(Box2, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 155, -1, -1));

        salesPanel1.add(itemPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 210, 530, 210));
        ...
        multiSalesPanel.add(UserName, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 20, 270, 50));
        ...
        multiPurchasesTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                multiPurchasesTableMousePressed(evt);
            }
        });
        multiPurchasesTable.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                multiPurchasesTableKeyPressed(evt);
            }
        });
        ...
        multiPurchasesComboBox.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        multiPurchasesComboBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                multiPurchasesComboBoxActionPerformed(evt);
            }
        });
        multiSalesPanel.add(multiPurchasesComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 20, 160, 50));
        ...
        checkId.setFont(new java.awt.Font("Segoe UI Semibold", 0, 20)); // NOI18N
        checkId.addCaretListener(new javax.swing.event.CaretListener() {
            public void caretUpdate(javax.swing.event.CaretEvent evt) {
                checkIdCaretUpdate(evt);
            }
        });
        multiSalesPanel.add(checkId, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 80, 270, 50));
    ...
    private void add_icon3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_add_icon3MouseClicked
        ...
        try {
            ...
            long stock_id = 0;
            int stockQuant = 0, flag = 0, flag2 = 0, clientId = 0, check_id = 0, branchId = 0;
            float salesprice, dept = 0, rest = 0, total = 0, quant = 0, price = 0, paid = 0, allTotal = 0, allRest = 0, allPaid = 0, oldDept = 0;
            ...
            mobile = Quant.getText();
            DBcon d = new DBcon();
            String branch = String.valueOf(multiPurchasesComboBox.getSelectedItem());
            ...
            if (flag != 0) {
                clientId = auto_insert("clients", "ID");
            } else {
            ...
            String sql3;
            if (flag != 0) {
                sql3 = "INSERT INTO `clients` (`ID`,`Name`, `Email`, `Mobile`, `dept`,`date`) VALUES ('" + clientId + "','" + client_name + "','unknown','" + mobile + "','" + dept + "','" + LocalDate.now() + "');";
                d.st = d.con.createStatement();
                d.st.executeUpdate(sql3);
            }
            int counter = 0;
            check_id = auto_insert("purchases", "check_id");
            d.rs = d.st.executeQuery("SELECT * FROM `branch` WHERE `branch`.`name`='" + branch + "';");
            while (d.rs.next()) {
                branchId = d.rs.getInt("id");
            }
            for (int i = 0; i < multiPurchasesTable.getRowCount(); i++) {
                //  if (multiPurchasesTable.getModel().getValueAt(i, 0) == null)
                // break;
                stock_id = Long.parseLong(String.valueOf(multiPurchasesTable.getModel().getValueAt(i, 0)));
                item = String.valueOf(multiPurchasesTable.getModel().getValueAt(i, 1));
                price = Float.parseFloat(String.valueOf(multiPurchasesTable.getModel().getValueAt(i, 2)));
                quant = Float.parseFloat(String.valueOf(multiPurchasesTable.getModel().getValueAt(i, 3)));
                //  paid = Float.parseFloat(String.valueOf(multiPurchasesTable.getModel().getValueAt(i, 4)));
                total = price * quant;
                //rest = total - paid;
                //dept += rest;
                allTotal += total;
                ...
                while ((d.rs).next()) {
                    if (item.equals(d.rs.getString("Name"))) {
                        flag2 = 0;
                        break;
                    } else {
                        flag2++;
                ...
                if (flag2 == 0) {
                    d.rs = d.st.executeQuery("SELECT * FROM `stock` WHERE stock.ID='" + stock_id + "';");
                    while ((d.rs).next()) {
                        stockQuant = d.rs.getInt("Quantity");
                    }
                    d.st = d.con.createStatement();
                    d.st.executeUpdate("UPDATE `stock` SET `Quantity` = '" + (stockQuant + quant) + "',`Price` = '" + price + "' WHERE ID = '" + stock_id + "';");
                } else {

                    try {
                        String sqll = "INSERT INTO stock(stock.`ID`, stock.`Name`, stock.`Quantity`,stock.`Price`,stock.`cons`,stock.`salesPrice`,stock.branch) VALUES ('" + stock_id + "', '" + item + "', '" + quant + "', '" + price + "', '10' , '0','" + branchId + "');";
                        d.st = d.con.createStatement();
                ...
                String sql2 = "INSERT INTO `multipurchases` (`ID`, `item`, `Quant`,`Price`) VALUES ('" + check_id + "', '" + item + "', '" + quant + "', '" + price + "');";
                d.st = d.con.createStatement();
            ...
            allPaid = Float.parseFloat(this.allPaid.getText());
            allRest = allTotal - allPaid;
            allrest.setText(String.valueOf(allRest));
            if (Box2.isSelected() == false) {
                allRest = 0;
            }
            String sql2 = "INSERT INTO `purchases` (`check_id`, `Total`, `Paid`, `Rest`, `client_id`, `stock_id`, `quantity`,`date`,`user`) VALUES ('" + check_id + "', '" + allTotal + "', '" + allPaid + "', '" + allRest + "', '" + clientId + "', '" + -1 + "', '" + counter + "', '" + LocalDate.now() + "', '" + getUser() + "');";
            d.st = d.con.createStatement();
            d.st.executeUpdate(sql2);
            d.st = d.con.createStatement();
            d.st.executeUpdate("Update `clients` SET `dept`= " + (oldDept + (-allRest)) + " WHERE ID = " + clientId + ";");
            this.total.setText(String.valueOf(allTotal));
            checkId.setText(String.valueOf(check_id));
    ...
    private void multiPurchasesTableMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_multiPurchasesTableMousePressed
        // select sales

    }//GEN-LAST:event_multiPurchasesTableMousePressed
    ...
    private void stockIdKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_stockIdKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            float price = 0;
            DBcon d = new DBcon();
            stock_id = Long.parseLong(stockId.getText());
            String branch = String.valueOf(multiPurchasesComboBox.getSelectedItem());
            String sql1 = "SELECT * FROM `stock`,branch WHERE branch.id = stock.branch  AND stock.ID='" + stock_id + "' AND branch.name = '" + branch + "';";
            try {
                d.rs = d.st.executeQuery(sql1);
                while ((d.rs).next()) {
                    stockName = d.rs.getString("Name");
            ...
            purchasesTable.addRow(new Object[]{
                stock_id,
                stockName,
                price,
                Quant.getText(),});
    ...
    private void allPaidFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_allPaidFocusGained
        ...
        for (int i = 0; i < purchasesTable.getRowCount(); i++) {
            price += Float.parseFloat(String.valueOf(multiPurchasesTable.getModel().getValueAt(i, 3))) * Float.parseFloat(String.valueOf(multiPurchasesTable.getModel().getValueAt(i, 2)));
        }
        total.setText(String.valueOf(price));
    }//GEN-LAST:event_allPaidFocusGained

    private void multiPurchasesTableKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_multiPurchasesTableKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_DELETE) {
            int n = multiPurchasesTable.getSelectedRow();
            purchasesTable.removeRow(n);
        }
    }//GEN-LAST:event_multiPurchasesTableKeyPressed

    private void multiPurchasesComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_multiPurchasesComboBoxActionPerformed

    }//GEN-LAST:event_multiPurchasesComboBoxActionPerformed
    ...
    private void print_lblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_print_lblMouseClicked
        ...
        try {
            ...
            arr.add(line);
            line = new PrintableLine(" وش السعد                             ");
            arr.add(line);
            line = new PrintableLine("     للمنظفات و مستحضرات التجميل               ");
            arr.add(line);
            line = new PrintableLine("     الشارع التجاري                         ");
            arr.add(line);

            line = new PrintableLine("ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ");
            arr.add(line);
            line = new PrintableLine("الوقت               ", "رقم الشيك");
            arr.add(line);
            s1 = String.valueOf(dtf.format(now));
            s2 = String.format("%12d", Integer.parseInt(checkId.getText()));
            ...
            arr.add(line);
            for (int i = 0; i < purchasesTable.getRowCount(); i++) {
                q = Integer.parseInt(String.valueOf(multiPurchasesTable.getModel().getValueAt(i, 3)));
                p = Float.parseFloat(String.valueOf(multiPurchasesTable.getModel().getValueAt(i, 2)));

                s1 = formatNumber(String.format("%03.2f", q * p)) + "    " + formatNumber(String.format("%03.2f", p)) + "      " + String.format("%4d", q);
                s2 = String.valueOf(multiPurchasesTable.getModel().getValueAt(i, 1));
                line = new PrintableLine(s1, s2);
                arr.add(line);
            }
            ...
            line = new PrintableLine("--------------------------------------------------------");
            arr.add(line);
            line = new PrintableLine("01226342663                       01223356530");
            arr.add(line);
            line = new PrintableLine("--------------------------------------------------------");
            arr.add(line);
            line = new PrintableLine("--- شركة Hash للبرمجيات     01068322486 ---");
            arr.add(line);
    ...
    private void checkIdCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_checkIdCaretUpdate
        // TODO add your handling code here:
    }//GEN-LAST:event_checkIdCaretUpdate
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(multiplePurchases.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
//                new multiplePurchases().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JComboBox<String> multiPurchasesComboBox;
    ...
    private javax.swing.JLabel quant_lbl;
